'''
2024-01-04
pivot attempt 2 and also not the same game concept anymore lmao

gonna try to generate random obstacles as well as a start and end point for the
 user to navigate using pivoting
